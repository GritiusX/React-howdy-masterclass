...
const Login = () => {
	...
	// const [state, dispatchFn] = useReducer(reducerFn,initialState,initFn); Reducer Example
	...
	const submitHandler = (event) => {
		...
		authCtx.onLogin(emailState.value, passwordState.value); // enteredEmail => email info sent before useReducer
	};
